...
const Notifications = () => {
  ...
  const renderContent = () => {
    ...
    if (activeTab === 'all' && !hasFriendRequests && !hasEventInvites) {
        return <p className="empty-msg-large">You currently have no new notifications. 📭</p>;
    }
                  ...
                  >
                    <div className="notif-info">
                      ...
                      <div>
                        ...
                        <span className="notif-text"> wants to be your friend.</span>
                      </div>
                    </div>
                    <div className="notif-actions">
                      <button className="btn-accept" onClick={() => handleFriendAction(req._id, 'accept')}>Accept</button>
           ...
           <div className="section-block">
             ...
             {eventInvites.map((inv) => (
                  ...
                  >
                    ...
                    <div className="notif-actions">
                      <button className="btn-accept" onClick={() => handleEventAction(inv._id, 'accept')}>I'm coming! 🍽️</button>
              ...
              <motion.div key="content" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
                ...
                <div className="notif-tabs">
                   ...
                   <button className={activeTab === 'events' ? 'active' : ''} onClick={() => setActiveTab('events')}>
                     Events {eventInvites.length > 0 && <span className="tab-badge">{eventInvites.length}</span>}
                   </button>
                </div>
